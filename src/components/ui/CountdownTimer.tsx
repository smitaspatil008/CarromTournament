  ...
  return (
    <div className="flex flex-col items-center">
      <motion.div
        ...
        className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center font-display font-bold text-xl sm:text-3xl text-white"
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="flex items-end gap-1.5 sm:gap-3">
        ...
        <span className="text-lg sm:text-2xl font-bold text-brand-purple mb-3">:</span>
