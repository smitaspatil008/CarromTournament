...
const placeholder = (n: number) => `https://i.pravatar.cc/150?img=${n}`;
const mkP = (id: string, name: string, photo: string, teamId: string): Player => ({
  id, name, photo, teamId, gamesPlayed: 0, wins: 0, losses: 0,
});

export const PLAYERS: Player[] = [
  // Carrom players (2 per team)
  mkP('p1',  'Gopal Kadam',           img('Gopal Kadam_Emp ID_100240 (1).jpg'),           'ct1'),
  mkP('p2',  'Akshay Nimbolkar',      img('100279 Akshay Nimbolkar.jpg'),                 'ct1'),
  mkP('p3',  'Amit Chavan',           img('Amit Chavan_Emp ID_100162.JPG'),                'ct2'),
  mkP('p4',  'Rupam Patil',           img('Rupam_Patil_100076.jpg'),                      'ct2'),
  mkP('p5',  'Maaj Patel',            placeholder(5),                                     'ct3'),
  mkP('p6',  'Shubham Sadare',        img('Shubham_sadare_Emp ID_100292 (1).jpg'),         'ct3'),
  mkP('p7',  'Umesh Warulkar',        placeholder(7),                                     'ct4'),
  mkP('p8',  'Pavan Rane',            placeholder(8),                                     'ct4'),
  mkP('p9',  'Vikas Sahu',            img('100288-Vikas Sahu (1).jpg'),                    'ct5'),
  mkP('p10', 'Sikandar Shaikh',       placeholder(10),                                    'ct5'),
  mkP('p11', 'Krushna Lavhare',       img('Krushna Lavhare 100261.jpg'),                   'ct6'),
  mkP('p12', 'Akshay Uikey',          img('Akshay Uikey 100248 (1).jpg'),                  'ct6'),
  mkP('p13', 'Hemant Nemade',         img('Hemant Nemade 100215.jpg'),                      'ct7'),
  mkP('p14', 'Vishal Rajbhar',        img('Vishal Rajbhar 100265 (1).jpg'),                 'ct7'),
  mkP('p15', 'Sanjay Saha',           img('100286-Sanjay Saha (1).jpg'),                    'ct8'),
  mkP('p16', 'Mayur Dorlikar',        img('Mayur_Dorlikar_100116.JPG'),                     'ct8'),
  mkP('p17', 'Taman',                 img('100277- Tamandeep Salh.jpg'),                    'ct9'),
  mkP('p18', 'Hitesh',                placeholder(18),                                     'ct9'),
  mkP('p19', 'Pushkaraj Kolatkar',    img('Pushkaraj Kolatkar_Emp ID 100137 (1).JPG'),     'ct10'),
  mkP('p20', 'Akshay Kumar Maddi',    img('Akshay Maddi 100245 (2).jpg'),                  'ct10'),
  mkP('p21', 'Hariom',                img('Hariom Tiwari.jpg'),                             'ct11'),
  mkP('p22', 'Tushar Shimpi',         img('Tushar Shimpi 100241.jpg'),                      'ct11'),
  mkP('p23', 'Shivam Gore',           img('Shivam Gore 100256.jpg'),                        'ct12'),
  mkP('p24', 'Krushna Bhosale',       img('Krushna Bhosle 100262.jpg'),                     'ct12'),
  mkP('p25', 'Sameer Dorlikar',       img('Sameer Dorlikar 100246 (1).jpg'),                'ct13'),
  mkP('p26', 'Nuran Khan',            img('Nuran Khan 100244.jpg'),                         'ct13'),
  mkP('p27', 'Sanjay',                placeholder(27),                                     'ct14'),
  mkP('p28', 'Ashish Singh',          placeholder(28),                                     'ct14'),
  mkP('p29', 'Alim',                  img('Alim Pathan Emp Id 100194.JPG'),                 'ct15'),
  mkP('p30', 'Ganesh U',              placeholder(30),                                     'ct15'),
  mkP('p31', 'Rahul Patil',           img('Rahul_Patil_100097 (1).jpg'),                    'ct16'),
  mkP('p32', 'Rakesh Nikalje',        img('100301 - Rakesh Nikalje.jpg'),                   'ct16'),
  // Sequence players (3 per team)
  mkP('sp1',  'Astitwa Roy',          img('Astitwa Roy 100183 (1).JPG'),                    'st1'),
  mkP('sp2',  'Garima Garg',          placeholder(36),                                     'st1'),
  mkP('sp3',  'Tejaswini Khade',      img('Tejaswani Khade 100195.JPG'),                    'st1'),
  mkP('sp4',  'Sofia Husain',         img('Sofia Husain Emp ID 100218.jpg'),                 'st2'),
  mkP('sp5',  'Ayush Koparde',        img('Ayush Koparde 100250 (1).jpg'),                   'st2'),
  mkP('sp6',  'Manik Bagul',          img('Manik Pawar 100081.JPG'),                         'st2'),
  ...
  mkP('sp10', 'Gauri Shirsath',       placeholder(44),                                      'st4'),
  ...
  mkP('sp14', 'Rushikesh Jadhav',     img('Rushikesh Jadhav Emp ID 100171.JPG'),             'st5'),
