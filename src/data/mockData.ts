...
export const CARROM_TEAMS: Team[] = [
  { id: 'ct1',  name: 'Thunder Strikers', logo: 'TS', color: '#2563EB', department: 'Engineering',    playerIds: ['p1','p2'],   wins: 3, losses: 0, points: 9,  status: 'active', game: 'carrom' },
  { id: 'ct2',  name: 'Royal Blazers',    logo: 'RB', color: '#7C3AED', department: 'Finance',        playerIds: ['p3','p4'],   wins: 2, losses: 1, points: 6,  status: 'active', game: 'carrom' },
  { id: 'ct3',  name: 'Iron Wolves',      logo: 'IW', color: '#F97316', department: 'HR',             playerIds: ['p5','p6'],   wins: 2, losses: 1, points: 6,  status: 'active', game: 'carrom' },
  { id: 'ct4',  name: 'Storm Eagles',     logo: 'SE', color: '#059669', department: 'Marketing',      playerIds: ['p7','p8'],   wins: 1, losses: 2, points: 3,  status: 'active', game: 'carrom' },
  { id: 'ct5',  name: 'Neon Panthers',    logo: 'NP', color: '#DB2777', department: 'Sales',          playerIds: ['p9','p10'],  wins: 3, losses: 0, points: 9,  status: 'active', game: 'carrom' },
  { id: 'ct6',  name: 'Titan Force',      logo: 'TF', color: '#D97706', department: 'Operations',     playerIds: ['p11','p12'], wins: 2, losses: 1, points: 6,  status: 'active', game: 'carrom' },
  { id: 'ct7',  name: 'Shadow Falcons',   logo: 'SF', color: '#0891B2', department: 'IT',             playerIds: ['p13','p14'], wins: 1, losses: 2, points: 3,  status: 'active', game: 'carrom' },
  { id: 'ct8',  name: 'Crimson Kings',    logo: 'CK', color: '#DC2626', department: 'Legal',          playerIds: ['p15','p16'], wins: 0, losses: 3, points: 0,  status: 'eliminated', game: 'carrom' },
  { id: 'ct9',  name: 'Sapphire Sharks',  logo: 'SS', color: '#1D4ED8', department: 'Design',         playerIds: ['p17','p18'], wins: 3, losses: 0, points: 9,  status: 'active', game: 'carrom' },
  { id: 'ct10', name: 'Golden Lions',     logo: 'GL', color: '#B45309', department: 'Product',        playerIds: ['p19','p20'], wins: 2, losses: 1, points: 6,  status: 'active', game: 'carrom' },
  { id: 'ct11', name: 'Phantom Aces',     logo: 'PA', color: '#6D28D9', department: 'QA',             playerIds: ['p21','p22'], wins: 2, losses: 1, points: 6,  status: 'active', game: 'carrom' },
  { id: 'ct12', name: 'Blaze Warriors',   logo: 'BW', color: '#EA580C', department: 'DevOps',         playerIds: ['p23','p24'], wins: 1, losses: 2, points: 3,  status: 'active', game: 'carrom' },
  { id: 'ct13', name: 'Arctic Storm',     logo: 'AS', color: '#0369A1', department: 'Support',        playerIds: ['p25','p26'], wins: 1, losses: 2, points: 3,  status: 'active', game: 'carrom' },
  { id: 'ct14', name: 'Venom Squad',      logo: 'VS', color: '#16A34A', department: 'Procurement',    playerIds: ['p27','p28'], wins: 0, losses: 3, points: 0,  status: 'eliminated', game: 'carrom' },
  { id: 'ct15', name: 'Delta Force',      logo: 'DF', color: '#7C3AED', department: 'Analytics',      playerIds: ['p29','p30'], wins: 1, losses: 2, points: 3,  status: 'active', game: 'carrom' },
  { id: 'ct16', name: 'Apex Predators',   logo: 'AP', color: '#B91C1C', department: 'Administration', playerIds: ['p31','p32'], wins: 0, losses: 3, points: 0,  status: 'eliminated', game: 'carrom' },
];

// ─── Sequence Teams (16 teams, 2 groups of 8) ─────────────────────────────────
export const SEQUENCE_TEAMS: Team[] = [
  { id: 'st1',  name: 'Phoenix Rising',   logo: 'PR', color: '#2563EB', department: 'Engineering',    playerIds: ['sp1','sp2'],   wins: 5, losses: 1, points: 15, status: 'active', game: 'sequence' },
  { id: 'st2',  name: 'Quantum Leap',     logo: 'QL', color: '#7C3AED', department: 'Finance',        playerIds: ['sp3','sp4'],   wins: 4, losses: 2, points: 12, status: 'active', game: 'sequence' },
  { id: 'st3',  name: 'Steel Gladiators', logo: 'SG', color: '#F97316', department: 'HR',             playerIds: ['sp5','sp6'],   wins: 3, losses: 3, points: 9,  status: 'active', game: 'sequence' },
  { id: 'st4',  name: 'Cosmic Riders',    logo: 'CR', color: '#059669', department: 'Marketing',      playerIds: ['sp7','sp8'],   wins: 2, losses: 4, points: 6,  status: 'active', game: 'sequence' },
  { id: 'st5',  name: 'Dragon Flames',    logo: 'DF', color: '#DB2777', department: 'Sales',          playerIds: ['sp9','sp10'],  wins: 6, losses: 0, points: 18, status: 'active', game: 'sequence' },
  { id: 'st6',  name: 'Electric Titans',  logo: 'ET', color: '#D97706', department: 'Operations',     playerIds: ['sp11','sp12'], wins: 3, losses: 3, points: 9,  status: 'active', game: 'sequence' },
  { id: 'st7',  name: 'Shadow Warriors',  logo: 'SW', color: '#0891B2', department: 'IT',             playerIds: ['sp13','sp14'], wins: 1, losses: 5, points: 3,  status: 'active', game: 'sequence' },
  { id: 'st8',  name: 'Cyber Knights',    logo: 'CK', color: '#DC2626', department: 'Legal',          playerIds: ['sp15','sp16'], wins: 0, losses: 6, points: 0,  status: 'eliminated', game: 'sequence' },
  { id: 'st9',  name: 'Frost Giants',     logo: 'FG', color: '#1D4ED8', department: 'Design',         playerIds: ['sp17','sp18'], wins: 5, losses: 1, points: 15, status: 'active', game: 'sequence' },
  { id: 'st10', name: 'Laser Sharks',     logo: 'LS', color: '#B45309', department: 'Product',        playerIds: ['sp19','sp20'], wins: 4, losses: 2, points: 12, status: 'active', game: 'sequence' },
  { id: 'st11', name: 'Nova Blazers',     logo: 'NB', color: '#6D28D9', department: 'QA',             playerIds: ['sp21','sp22'], wins: 3, losses: 3, points: 9,  status: 'active', game: 'sequence' },
  { id: 'st12', name: 'Turbo Rockets',    logo: 'TR', color: '#EA580C', department: 'DevOps',         playerIds: ['sp23','sp24'], wins: 2, losses: 4, points: 6,  status: 'active', game: 'sequence' },
  { id: 'st13', name: 'Solar Flares',     logo: 'SF', color: '#0369A1', department: 'Support',        playerIds: ['sp25','sp26'], wins: 4, losses: 2, points: 12, status: 'active', game: 'sequence' },
  { id: 'st14', name: 'Stone Crushers',   logo: 'SC', color: '#16A34A', department: 'Procurement',    playerIds: ['sp27','sp28'], wins: 2, losses: 4, points: 6,  status: 'active', game: 'sequence' },
  { id: 'st15', name: 'Wind Riders',      logo: 'WR', color: '#7C3AED', department: 'Analytics',      playerIds: ['sp29','sp30'], wins: 1, losses: 5, points: 3,  status: 'active', game: 'sequence' },
  { id: 'st16', name: 'Ocean Breakers',   logo: 'OB', color: '#B91C1C', department: 'Administration', playerIds: ['sp31','sp32'], wins: 0, losses: 6, points: 0,  status: 'eliminated', game: 'sequence' },
];

export const ALL_TEAMS = [...CARROM_TEAMS, ...SEQUENCE_TEAMS];

// ─── Players ──────────────────────────────────────────────────────────────────
const makePlayer = (id: string, name: string, dept: string, teamId: string, img: number, w: number, l: number): Player => ({
  id, name, photo: `https://i.pravatar.cc/150?img=${img}`, department: dept, teamId, gamesPlayed: w + l, wins: w, losses: l,
});

export const PLAYERS: Player[] = [
  makePlayer('p1',  'Arjun Sharma',   'Engineering', 'ct1',  1, 6, 1),
  makePlayer('p2',  'Riya Desai',     'Engineering', 'ct1',  5, 5, 2),
  makePlayer('p3',  'Vikram Rao',     'Finance',     'ct2', 10, 4, 2),
  makePlayer('p4',  'Priya Nair',     'Finance',     'ct2', 15, 4, 3),
  makePlayer('p5',  'Amit Kumar',     'HR',          'ct3', 20, 5, 2),
  makePlayer('p6',  'Sneha Patil',    'HR',          'ct3', 25, 4, 3),
  makePlayer('p7',  'Rajesh Mehta',   'Marketing',   'ct4', 30, 3, 4),
  makePlayer('p8',  'Kavya Singh',    'Marketing',   'ct4', 35, 3, 4),
  makePlayer('p9',  'Deepak Joshi',   'Sales',       'ct5', 40, 6, 1),
  makePlayer('p10', 'Ananya Gupta',   'Sales',       'ct5', 45, 6, 1),
  makePlayer('p11', 'Suresh Iyer',    'Operations',  'ct6', 50, 4, 3),
  makePlayer('p12', 'Meera Pillai',   'Operations',  'ct6', 55, 4, 3),
  makePlayer('p13', 'Karthik Reddy',  'IT',          'ct7', 60, 3, 4),
  makePlayer('p14', 'Pooja Varma',    'IT',          'ct7', 65, 3, 4),
  makePlayer('p15', 'Nikhil Bose',    'Legal',       'ct8', 70, 1, 6),
  makePlayer('p16', 'Aisha Khan',     'Legal',       'ct8', 75, 1, 6),
  makePlayer('p17', 'Rahul Chandra',  'Design',      'ct9',  2, 6, 0),
  makePlayer('p18', 'Divya Menon',    'Design',      'ct9',  6, 6, 1),
  makePlayer('p19', 'Sanjay Tiwari',  'Product',     'ct10',11, 4, 3),
  makePlayer('p20', 'Lakshmi Das',    'Product',     'ct10',16, 4, 3),
  makePlayer('p21', 'Manish Verma',   'QA',          'ct11',21, 5, 2),
  makePlayer('p22', 'Sunita Ghosh',   'QA',          'ct11',26, 4, 3),
  makePlayer('p23', 'Ravi Shastri',   'DevOps',      'ct12',31, 3, 4),
  makePlayer('p24', 'Nisha Kapoor',   'DevOps',      'ct12',36, 3, 4),
  makePlayer('p25', 'Anil Saxena',    'Support',     'ct13',41, 3, 4),
  makePlayer('p26', 'Rekha Pandey',   'Support',     'ct13',46, 3, 4),
  makePlayer('p27', 'Mohit Agarwal',  'Procurement', 'ct14',51, 1, 6),
  makePlayer('p28', 'Shilpa Jain',    'Procurement', 'ct14',56, 1, 6),
  makePlayer('p29', 'Tarun Bajaj',    'Analytics',   'ct15',61, 3, 4),
  makePlayer('p30', 'Pallavi Sinha',  'Analytics',   'ct15',66, 3, 4),
  makePlayer('p31', 'Vinay Mishra',   'Administration','ct16',71, 1, 6),
  makePlayer('p32', 'Geeta Rajan',    'Administration','ct16',76, 1, 6),
  // Sequence players
  makePlayer('sp1',  'Harish Kumar',   'Engineering', 'st1',  3,  5, 1),
  makePlayer('sp2',  'Sanya Malik',    'Engineering', 'st1',  7,  6, 0),
  makePlayer('sp3',  'Prem Anand',     'Finance',     'st2', 12,  4, 2),
  makePlayer('sp4',  'Trisha Roy',     'Finance',     'st2', 17,  5, 1),
  makePlayer('sp5',  'Gopal Nair',     'HR',          'st3', 22,  3, 3),
  makePlayer('sp6',  'Mala Shetty',    'HR',          'st3', 27,  4, 2),
  makePlayer('sp7',  'Pranav Joshi',   'Marketing',   'st4', 32,  2, 4),
  makePlayer('sp8',  'Deepa Srinivas', 'Marketing',   'st4', 37,  3, 3),
  makePlayer('sp9',  'Kiran Hegde',    'Sales',       'st5', 42,  6, 0),
  makePlayer('sp10', 'Ritu Sharma',    'Sales',       'st5', 47,  6, 0),
  makePlayer('sp11', 'Sunil Mistry',   'Operations',  'st6', 52,  3, 3),
  makePlayer('sp12', 'Geetha Rao',     'Operations',  'st6', 57,  3, 3),
  makePlayer('sp13', 'Ajay Pillai',    'IT',          'st7', 62,  1, 5),
  makePlayer('sp14', 'Sindhu Nath',    'IT',          'st7', 67,  2, 4),
  makePlayer('sp15', 'Balram Tewari',  'Legal',       'st8', 72,  0, 6),
  makePlayer('sp16', 'Radha Krishnan', 'Legal',       'st8', 77,  0, 6),
  makePlayer('sp17', 'Vijay Murthy',   'Design',      'st9',  4,  5, 1),
  makePlayer('sp18', 'Preethi Suresh', 'Design',      'st9',  8,  5, 1),
  makePlayer('sp19', 'Naveen Das',     'Product',     'st10',13,  4, 2),
  makePlayer('sp20', 'Charu Mehta',    'Product',     'st10',18,  4, 2),
  makePlayer('sp21', 'Salil Gupta',    'QA',          'st11',23,  3, 3),
  makePlayer('sp22', 'Kamala Rajan',   'QA',          'st11',28,  4, 2),
  makePlayer('sp23', 'Nitin Bhatt',    'DevOps',      'st12',33,  2, 4),
  makePlayer('sp24', 'Leela Naik',     'DevOps',      'st12',38,  2, 4),
  makePlayer('sp25', 'Dhanraj Patel',  'Support',     'st13',43,  4, 2),
  makePlayer('sp26', 'Anita Singh',    'Support',     'st13',48,  4, 2),
  makePlayer('sp27', 'Rakesh Thakur',  'Procurement', 'st14',53,  2, 4),
  makePlayer('sp28', 'Usha Kulkarni',  'Procurement', 'st14',58,  2, 4),
  makePlayer('sp29', 'Santosh Kumar',  'Analytics',   'st15',63,  1, 5),
  makePlayer('sp30', 'Poornima Iyer',  'Analytics',   'st15',68,  2, 4),
  makePlayer('sp31', 'Madhu Krishnap', 'Administration','st16',73,0, 6),
  makePlayer('sp32', 'Kavitha Rao',    'Administration','st16',78,0, 6),
];
