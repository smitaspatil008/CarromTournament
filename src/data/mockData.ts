...
export const PLAYERS: Player[] = [
  ...
  mkP('p5',  'Maaj Patel',            img('Maaz PAtel.png'),                               'ct3'),
  mkP('p6',  'Shubham Sadare',        img('Shubham_sadare_Emp ID_100292 (1).jpg'),         'ct3'),
  mkP('p7',  'Umesh Warulkar',        img('Umesh.png'),                                    'ct4'),
  mkP('p8',  'Pavan Rane',            img('Pavan.jpg'),                                    'ct4'),
  mkP('p9',  'Vikas Sahu',            img('100288-Vikas Sahu (1).jpg'),                    'ct5'),
  mkP('p10', 'Sikandar Shaikh',       img('Sikandar.jpg'),                                 'ct5'),
  ...
  mkP('p18', 'Hitesh',                img('Hitesh.jpg'),                                    'ct9'),
  ...
  mkP('p27', 'Sanjay',                img('Sanjay.jpg'),                                   'ct14'),
  mkP('p28', 'Ashish Singh',          img('Ashish Singh.jpg'),                             'ct14'),
  mkP('p29', 'Alim',                  img('Alim Pathan Emp Id 100194.JPG'),                 'ct15'),
  mkP('p30', 'Ganesh U',              img('Ganesh U.jpg'),                                  'ct15'),
  ...
  mkP('sp2',  'Garima Garg',          img('Garima G.jpg'),                                  'st1'),
